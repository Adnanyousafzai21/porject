...
const Contact = () => {
    return (
        <div className=''>
      <div className='mt-8  bg-themshadow lg:py-20 py-10 '>
      <div className=" mt-8 ">
            ...
            <div>
                <div className="m-auto w-[100%] lg:w-[70%] my-10 ">
                    <div className='flex flex-col lg:gap-6 text-heading gap-3 items-center justify-center w-[100%] border'>
                        <div className='border w-[80%] lg:w-[50%]'>
